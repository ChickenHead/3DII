...
box& operator+=( box& a,vectorM const& b )
{
    a.x += b.x();
    a.y += b.y();
    a.z += b.z();
...
box operator+( box const& a,vectorM const& b )
{
    box c( a );
...
box operator+(vectorM const& b, box const& a )
{
    box c( a );
