...
class box
{
  private:
    ...
    // addtion
    friend box& operator+=( box&, vectorM const& );
    friend box  operator+( box const&, vectorM const& );
    friend box  operator+( vectorM const&, box const& );
  ...
  public:
    ...
    vectorM project( const vectorM& ) const;
};
