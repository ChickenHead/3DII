...
transf identity_transf( scaling(1),vectorM(0,0,0) );
...
transf rotate_transf( m_real angle, vectorM const& axis )
{
...
transf reflect_transf( vectorM const& axis )
{
...
transf translate_transf( vectorM const& axis )
{
...
{
    return transf( scaling( 1.0 ),vectorM(x,y,z) );
}
                          ...
                          unit_vector const& new_y )
{
    ...
    vectorM x_axis( 1.0, 0.0, 0.0 );
    vectorM y_axis( 0.0, 1.0, 0.0 );
    vectorM z_axis( 0.0, 0.0, 1.0 );
...
interpolate( m_real t, transf const& a, transf const& b )
{
	...
	vectorM v = ::interpolate( t, a.getTranslation(), b.getTranslation() );
