...
public:
	...
	static void segmentAroundAFacet(/*std::vector< std::vector<Polyhedron::Facet_handle> >*/std::vector<Polyhedron::Facet_handle> & segments, const Polyhedron::Halfedge_around_facet_circulator facet_circulator, double sensitivity, vxfloat3 average_normal,int call_depth);
